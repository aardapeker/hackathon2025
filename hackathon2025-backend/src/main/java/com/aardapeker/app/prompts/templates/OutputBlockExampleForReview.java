    ...
    public static final String VALUE = """
            {
                "originalInput": [
                    {
                        "category":"wordChoice",
                        "questionText":"Which phrase is most appropriate when asking a manager for a report in a professional setting?",
                        "correctAnswer":"Could you please provide the report?",
                        "selectedAnswer":"Gimme the report, fam."
                    },
                    {
                        "category":"wordChoice",
                        "questionText":"In a professional setting, which word is the most appropriate to describe a very clever idea?",
